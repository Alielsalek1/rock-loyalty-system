...
{
    /// <summary>
    /// Handles Google OAuth2 sign-in and creates or authenticates a user.
    /// </summary>
    /// <param name="body">The OAuth2 body containing the Google access token and restaurant ID.</param>
    /// <returns>
    ...
    /// <response code="400">Invalid request body or Google token.</response>
    /// <response code="500">Server error during authentication.</response>
    /// <remarks>
    /// Sample request:
    ///
    ///     POST /api/oauth2/signin-google
    ///     {
